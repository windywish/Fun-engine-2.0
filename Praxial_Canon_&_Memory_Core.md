...
*   **The Evaluation:** Each experience is scored against a Salience Metric ($S$).
*   **The Consolidation:** Only experiences where $S > Threshold$ are written to the `Long-Term Memory Core`.
...
*   **Layer 2 (Formalism):**
    $$S = w_1(Novelty) + w_2(Utility) + w_3(Emotional\_Weight)$$
